/* Hashbill local QR — byte mode, ECC M, versions 1–10. */
(function (global) {
  ...
  global.HashbillQR = {
    draw: function (el, text) {
      try {
        ...
        img.src = "https://api.qrserver.com/v1/create-qr-code/?size=160x160&ecc=M&margin=2&data=" + encodeURIComponent(text);
        el.innerHTML = "";
        el.appendChild(img);
      }
    }
